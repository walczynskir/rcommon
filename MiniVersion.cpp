...
BOOL CMiniVersion::Init()
{
	...
	GetStringInfo(_T("CompanyName"),     m_szCompanyName, ArraySize(m_szCompanyName));
	GetStringInfo(_T("FileDescription"), m_szFileDescription, ArraySize(m_szFileDescription));
	GetStringInfo(_T("ProductName"),     m_szProductName, ArraySize(m_szProductName));
...
///////////////////////////////////////////////////////////////////////////////
// GetStringInfo
BOOL CMiniVersion::GetStringInfo(LPCTSTR lpszKey, LPTSTR lpszReturnValue, size_t returnValueSize)
{
	BOOL rc;
	...
	*lpszReturnValue = 0;
	...
	TCHAR szKey[2000];
	_stprintf_s(szKey, ArraySize(szKey), _T("\\StringFileInfo\\%04x%04x\\%s"),
	...
	_tcsncpy_s(lpszReturnValue, returnValueSize, lpszValue, returnValueSize - 1);

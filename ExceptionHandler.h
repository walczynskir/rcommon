...
extern RCOMMON_API int __cdecl RecordExceptionInfo(PEXCEPTION_POINTERS data, LPCTSTR a_lpszMessage);
extern RCOMMON_API void __cdecl RecordExceptionInfo(LPCTSTR a_lpszMessage);
